...
#  data : input.tert$ca_meq 
#  lambda.hat : 0.25 
#  p.value    : 7.127511e-29 
#  Result     : Transformed data are not normal. 
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# magnesium
...
mg.df <- as.data.frame(mg$lambda.hat) 
#   Box-Cox Power Transformation 
#  data : input.tert$mg_meq 
#  lambda.hat : -1.85 
#  p.value    : 2.72284e-34 
#  Result     : Transformed data are not normal. 
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# sodium
# have a couple of zero values for na that need to be positive
input.tert <- input.tert %>%
  mutate(na_meq = na_meq + 0.01)
...
#  Box-Cox Power Transformation 
#  data : input.tert$k_meq 
#  lambda.hat : 1.3 
#  p.value    : 1.487123e-23 
#  Result     : Transformed data are not normal. 
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# chloride
# have a couple of zero values for cl that need to be positive
input.tert <- input.tert %>%
  mutate(cl_meq = cl_meq + 0.01)
...
# Box-Cox Power Transformation 
#  data : input.tert$cl_meq 
#  lambda.hat : 0 
#  p.value    : 3.201819e-16 
#  Result     : Transformed data are not normal. 
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
# fluoride
...
#  Box-Cox Power Transformation 
#  data : input.tert$f_meq 
# lambda.hat : 0.5 
#  p.value    : 6.858415e-17 
#  Result     : Transformed data are not normal. 
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
# sulfate
# have a couple of zero values for so4 that need to be positive
input.tert <- input.tert %>%
  mutate(so4_meq = so4_meq + 0.01)
...
rm(ca.df, ca_mg_rat, cl.df, f.df, k.df, mg.df, na.df, so4.df)
...
The screeplots indicate the four principal components are relevant and explain about 80% of the variance of the data.
...
p1 <- autoplot(input.pca, data = input, shape = "class",  
...
```
 ...
 the strong outlier does not look as if it affects the ordination.
