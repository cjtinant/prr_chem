...
```{r munge.data.input_mass}
# The input_mass is subsetted from the cleaned raw data.  Input mass
...
#glimpse(input_mass)
# in validating variables I am using the largest factor group, ecoregion
p1 <- ggplot(clean, aes(year, ph)) +
  geom_boxplot() +
  theme_tufte() +
  ggtitle("Exploratory pH Boxplot")
p1
